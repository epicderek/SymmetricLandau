function [pfig, cfigs, rf, phif] = plotProfile(rf, phif, wf, Jcs, titleStrs)
...
pfig = plotPDensity(wf, rf, phif, titleStrs{1});
...
for k = 1: length(Jcs)
    cfigs{k} = plotCurrent(Jcs{k}, rf, phif, titleStrs{k+1});
end
